...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToDoApp = _react2.default.createClass({
		...
		handleToggleComplete: function handleToggleComplete(id) {
		...
		clearTasks: function clearTasks(e) {
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(ToDoList, { data: this.state.data, toggleComplete: this.handleToggleComplete }),
					_react2.default.createElement(AddTaskForm, { onAddTask: this.handleSubmit }),
					_react2.default.createElement(
						'div',
						{ className: 'btn btn-danger pull-right', type: 'button', id: 'clear', onClick: this.clearTasks },
						'Clear List'
					)
				)
			);
	...
	var AddTaskForm = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'text', id: 'task', ref: 'task', className: 'addTask', placeholder: 'Add a task' })
			);
		}
	});
		...
		render: function render() {
			...
			if (this.props.data) {
				listNodes = this.props.data.map(function (listItem) {
					return _react2.default.createElement(ToDoTask, { key: listItem.id, id: listItem.id, task: listItem.task, complete: listItem.complete, toggleComplete: this.toggleComplete });
				}, this);
			}
			return _react2.default.createElement(
				'ul',
	...
	var ToDoTask = _react2.default.createClass({
